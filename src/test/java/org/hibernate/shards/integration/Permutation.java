...
public final class Permutation {
	...
	static final Permutation DEFAULT = new Permutation(
			IdGenType.SIMPLE,
			ShardAccessStrategyType.SEQUENTIAL,
			3,
			3,
			false
	);
	...
	public Permutation(
			final IdGenType idGenType, final ShardAccessStrategyType sast,
	...
	public String toString() {
		return idGenType.name() + " - " + sast.name() + " - " + numDbs + (virtualShardingEnabled ?
				" - " + numShards + " VIRTUAL SHARDS" :
				"");
	}
