 ...
 */
public class ParallelShardOperationCallableTest {
	...
	public void testCountDown() throws Exception {
		...
		ParallelShardOperationCallable<Void> callable = new ParallelShardOperationCallable<>(
				startLatch,
				latch,
				strat,
				operation,
		...
		Callable<Void> anotherCallable = () -> null;
